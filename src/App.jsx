      ...
      <main className="min-h-svh bg-offwhitebg py-20 px-6 antialiased lg:flex justify-center items-center">
        <section className="lg:flex">
          ...
          <div className="bg-dark-green p-12 rounded-b-lg">
            ...
            <a className="font-lexend bg-offwhitebg block px-10 py-3 w-fit rounded-3xl text-dark-green" href="https://www.webmotors.com.br/carros-eletricos" target="_blank">Ver mais</a>
          </div>
        </section>
      </main>
  )
